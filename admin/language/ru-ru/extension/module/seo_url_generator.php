...
$_['text_success']   = 'Настройки модуля SEO URL Generator FREE обновлены!';
...
$_['entry_system']          = 'Вы используете систему'; // for OC 2.x only
...
$_['entry_language_id']           = 'Исходный язык'; // for OC 2.x only
...
/* FREE VERSION
-------------------------------------------- */
$_['text_part_info'] = 'Информация о модуле';
$_['text_about_title'] = 'О модуле';
$_['text_about'] = '<p>Этот модуль, пожалуй, самый "замороченный" модуль на тему SEO URL в OpenCart.</p>
				<p>В отличие от многих похожих решений, <b>SEO URL Generator PRO by Serge Tkach</b> позволяет Вам вписывать редиректы для товаров, категорий, производителей. Ведь такое бывает, что товару или категории необходимо присвоить другую ссылку. Во многих других CMS подобный функционал есть из коробки. С помощью данного модуля такое возможно и в OpenCart.</p>
				<p>Также модуль может "проследить" за тем, чтобы SEO URL сами менялись в случае, когда Вы меняете название товара. При этом старый ЧПУ (которые уже может находиться в результатах поиска), автоматически будет перенаправлять на новый ЧПУ с редиректом 301.</p>';
$_['text_about_pro_title'] = 'О платной версии модуля';
$_['text_about_pro'] = '<p>Платная версия модуля <b>SEO URL Generator PRO by Serge Tkach</b> позволяет генерировать SEO URL не только для отдельно взятого товара, а массово сгенерировать ЧПУ для сотен или тысяч товаров, которые уже есть в магазине. Или которые "прилетят" завтра при импорте от поставщика. Массовая генерация также может пригодиться в случае, если в Вашем магазине уже есть ЧПУ, но они морально устарели (используется нижнее подчеркивание) или в принципе нужно заменить их на более короткий вариант (к примеру, по product_id).</p>';