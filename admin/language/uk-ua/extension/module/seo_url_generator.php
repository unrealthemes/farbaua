...
$_['text_about'] = '<p>Цей модуль, мабуть, самий "заморочений" модуль на тему SEO URL в OpenCart.</p>
				<p>На відміну від багатьох схожих рішень, <b>SEO URL Generator PRO by Serge Tkach</b> дозволяє Вам вписувати редіректи для товарів, категорій, виробників. Адже таке буває, що товару або категорії необхідно присвоїти інше посилання. У багатьох інших CMS подібний функціонал є з коробки. За допомогою даного модуля таке можливо і в OpenCart.</p>
				<p>Також модуль може "простежити" за тим, щоб SEO URL самі змінювалися в разі, коли Ви змінюєте назву товару. При цьому старий ЧПУ (які вже може знаходитися в результатах пошуку), автоматично буде перенаправляти на новий ЧПУ з перенаправленням 301.</p>';
