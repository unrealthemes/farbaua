<?php
class ControllerCommonCatshemeNewstorePos10 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_10');
		...
		return $this->load->view('common/catsheme/newstore_pos10', $data);		
	}
}