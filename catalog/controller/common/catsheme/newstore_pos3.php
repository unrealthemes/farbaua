<?php
class ControllerCommonCatshemeNewstorePos3 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_3');
		...
		return $this->load->view('common/catsheme/newstore_pos3', $data);		
	}
}