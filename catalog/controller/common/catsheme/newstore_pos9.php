<?php
class ControllerCommonCatshemeNewstorePos9 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_9');
		...
		return $this->load->view('common/catsheme/newstore_pos9', $data);		
	}
}