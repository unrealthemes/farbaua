<?php
class ControllerCommonCatshemeNewstorePos4 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_4');
		...
		return $this->load->view('common/catsheme/newstore_pos4', $data);		
	}
}