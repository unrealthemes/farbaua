<?php
class ControllerCommonCatshemeNewstorePos5 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_5');
		...
		return $this->load->view('common/catsheme/newstore_pos5', $data);		
	}
}