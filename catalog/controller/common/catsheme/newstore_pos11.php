<?php
class ControllerCommonCatshemeNewstorePos11 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_11');
		...
		return $this->load->view('common/catsheme/newstore_pos11', $data);		
	}
}