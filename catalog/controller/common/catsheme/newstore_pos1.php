<?php
class ControllerCommonCatshemeNewstorePos1 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_1');
		...
		return $this->load->view('common/catsheme/newstore_pos1', $data);		
	}
}