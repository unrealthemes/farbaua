<?php
class ControllerCommonCatshemeNewstorePos8 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_8');
		...
		return $this->load->view('common/catsheme/newstore_pos8', $data);		
	}
}