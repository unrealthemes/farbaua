<?php
class ControllerCommonCatshemeNewstorePos6 extends Controller {
	public function index() {
		...
		$data['modules'] = array();		
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'position_6');
		...
		return $this->load->view('common/catsheme/newstore_pos6', $data);		
	}
}