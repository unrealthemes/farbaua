...
//ocm_CKeditorIsBack_end
				...
				$data['images'][] = array(
					...
					'href'  => $this->url->link('common/filemanagernew', 'user_token=' . $this->session->data['user_token'] . '&directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE . 'catalog/'))) . $url, 'SSL')
				);
...
//ocm_CKeditorIsBack_end
		...
		$data['parent'] = $this->url->link('common/filemanagernew', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
...
//ocm_CKeditorIsBack_end
		...
		$data['refresh'] = $this->url->link('common/filemanagernew', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
...
//ocm_CKeditorIsBack_end
		...
		$pagination->limit = 16;
		$pagination->url = $this->url->link('common/filemanagernew', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
